...
It's worth noting that certain characters often will confuse users if they are manually entering a password as viewed in an email.  Fonts can make characters including the following difficult to distinguish
...
You can _(code)String#tr_ these out for substitutions, or strip them alltogether.  This will slightly reduce entropy, but by keeping a longer
password you compensate somewhat.
